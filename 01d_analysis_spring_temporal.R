...
tbl_locs_plot <- tbl_locs_all %>% 
  ...
  dplyr::filter(Season=="SpringMig" |
                  (lead(Season)=="SpringMig" & Order != 1) |
                  lag(Season)=="SpringMig") %>% 
  dplyr::mutate(Duration=ifelse(Type=="Band",0,Duration),
                Duration=ifelse(lead(Season)=="Breed2",0,Duration)) %>% 
...
#ggsave(plot=plot, "/Users/ellyknight/Documents/UoA/Projects/Projects/MCP2/Analysis/Figs/SpringSpatialVisualization.jpeg", device="jpeg", width=20, height=16, units="in")
...
IDs <- tbl_IDs %>% 
  dplyr::filter((selectcont >= 1) |
                  (PinpointID %in% c(61, 430, 433, 821, 826, 827))) %>% 
  arrange(PinpointID)
nbirds <- nrow(IDs)
nbirds
table(IDs$pop)
...
write.csv(PredDataAll, "/Users/ellyknight/Documents/UoA/Projects/Projects/MCP2/Analysis/Results/CRAWL_MigConnectvitiy_Spring_Temporal_1s-NA.csv", row.names = FALSE)
...
st_write(sf_lines_mean, "/Users/ellyknight/Documents/UoA/Projects/Projects/MCP2/Analysis/Results/CRAWL_MigConnectivity_Spring_Temporal_Mean.shp", delete_dsn=TRUE)
st_write(sf_lines_up, "/Users/ellyknight/Documents/UoA/Projects/Projects/MCP2/Analysis/Results/CRAWL_MigConnectivity_Spring_Temporal_Upper.shp", delete_dsn=TRUE)
st_write(sf_lines_lw, "/Users/ellyknight/Documents/UoA/Projects/Projects/MCP2/Analysis/Results/CRAWL_MigConnectivity_Spring_Temporal_Lower.shp", delete_dsn=TRUE)
st_write(sf_locs_wgs, "/Users/ellyknight/Documents/UoA/Projects/Projects/MCP2/Analysis/Results/CRAWL_MigConnectivity_Spring_Temporal_Points.shp", delete_dsn=TRUE)
write.csv(tbl_locs, "/Users/ellyknight/Documents/UoA/Projects/Projects/MCP2/Analysis/Results/CRAWL_MigConnectivity_Spring_Temporal_Points.csv", row.names = FALSE)
...
ggsave(plot = plot2, "/Users/ellyknight/Documents/UoA/Projects/Projects/MCP2/Analysis/Figs/CRAWL_MigConnectivity_Spring_Temporal_1s-NA.jpeg", device="jpeg", width=20, height=20, units="in")
...
table(PredData_Spring_Temp$doy, PredData_Spring_Temp$population)
table(PredData_Spring_Temp$doy, PredData_Spring_Temp$deployid)
...
write.csv(spring.doys, "/Users/ellyknight/Documents/UoA/Projects/Projects/MCP2/Analysis/Results/PopulationCount_SpringTemporal.csv", row.names = FALSE)
...
for(h in 1:length(days)){
  ...
  #17. Full model connectivity loop----
  mantel <- list()
  ...
  print(paste0("COMPLETED ", h, " of ", length(days), " ITERATIONS"))
...
write.csv(spring.temporal, "/Users/ellyknight/Documents/UoA/Projects/Projects/MCP2/Analysis/Results/MigratoryConnectivity_Spring_Temporal_LeaveOneOut_MantelV4.csv", row.names = FALSE)

spring.temporal <- read.csv("/Users/ellyknight/Documents/UoA/Projects/Projects/MCP2/Analysis/Results/MigratoryConnectivity_Spring_Temporal_LeaveOneOut_MantelV4.csv")
...
plot1 <- ggplot() +
  geom_hex(aes(x=doy, y=M), data=spring.temporal) +
  geom_smooth(aes(x=doy, y=M), data=spring.temporal) +
  scale_fill_viridis_c() +
  facet_wrap(~day) +
  theme(legend.position = "bottom")

plot2 <- ggplot(spring.temporal.sum) +
...
save.image("/Users/ellyknight/Documents/UoA/Projects/Projects/MCP2/Analysis/Results/MigratoryConnectivity_Spring_Temporal_MantelV3.R")
#load("/Users/ellyknight/Documents/UoA/Projects/Projects/MCP2/Analysis/Results/MigratoryConnectivity_Spring_Temporal_MantelV3.R")
